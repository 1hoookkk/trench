...
fn canonical_profile(az_rad: f32, distance_m: f32, el_rad: f32) -> SpatialProfile {
    SpatialProfile {
        ...
        elevation: el_rad,
        itd_coeffs: [
             3578.764_6,   -99.113_0,   -960.709_6,
              631.036_1,  -229.782_3,   -173.118_7,
        ],
        ild_coeffs: [
             6.819_731_5, -2.500_813,   0.821_019_9,
            -0.198_121,    0.021_401_3, 8.819_077e-5,
        ],
        band_coeffs: BandCoeffs {
            l: BandChannelCoeffs {
                low:  [-72.211_726, 0.386_310, -1.609_965, -2.942_365, 4.905_630, 0.894_425, -1.686_776, -0.082_666, 0.833_466, 0.0, 0.0, 0.0],
                mid:  [-74.892_487, 0.460_364, -1.645_200, -2.794_224, 9.547_364, 1.100_615, -2.989_885, -0.168_168, 1.485_241, 0.0, 0.0, 0.0],
                high: [-73.911_507, 0.438_043, -1.634_712, -2.835_356, 8.046_734, 1.041_892, -2.546_882, -0.132_837, 1.302_472, 0.0, 0.0, 0.0],
            },
            r: BandChannelCoeffs {
                low:  [-72.211_726, 0.386_310, -1.609_965,  2.942_365, 4.905_630, -0.894_425, -1.686_776,  0.082_666, 0.833_466, 0.0, 0.0, 0.0],
                mid:  [-74.892_487, 0.460_364, -1.645_200,  2.794_224, 9.547_364, -1.100_615, -2.989_885,  0.168_168, 1.485_241, 0.0, 0.0, 0.0],
...
fn full_scale_azimuth_sweep_never_exceeds_unity_peak() {
    ...
    for deg in (-60..=60).step_by(10) {
        ...
        let peak = l.iter().chain(r.iter()).fold(0.0_f32, |m, &v| m.max(v.abs()));
        assert!(
