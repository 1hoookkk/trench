...
verbatim from `cartridges/factory/_source/shapes/<category>/<key>.json`.
"""
...
INVENTORY_PATH = REPO_ROOT / "cartridges" / "factory" / "_source" / "token_inventory_unified_v2.json"
SHAPES_ROOT = REPO_ROOT / "cartridges" / "factory" / "_source" / "shapes"
