...
Reads:
  ...
  - cartridges/factory/_source/heritage_designer_sections.json (83 factory P2K templates)
...
def main():
    ...
    factory_group.set("source", "cartridges/factory/_source/heritage_designer_sections.json")
