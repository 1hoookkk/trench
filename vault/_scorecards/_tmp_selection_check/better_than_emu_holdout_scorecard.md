...
- Design balance output counts: `{'bass': 5, 'vocal': 5, 'drum': 5, 'mix': 5}`
- Design balance target count: `5`
- Holdout balance input counts: `{'bass': 14, 'vocal': 14, 'drum': 14, 'mix': 14}`
- Holdout balance output counts: `{'bass': 5, 'vocal': 5, 'drum': 5, 'mix': 5}`
- Holdout balance target count: `5`
...
|---|---|---:|---:|---:|---:|---|
| Speaker Knockerz | Speaker Knockerz C4 | True | True | 3 | 2.263 | Speaker Knockerz C4 |
| Aluminum Siding | Aluminum Siding C2 | True | True | 3 | 3.000 | Aluminum Siding C2 |
| Small Talk Ah-Ee | Small Talk Ah-Ee C2 | True | True | 4 | 3.655 | Small Talk Ah-Ee C2 |
| Cul-De-Sac | (none) | False | False | 0 | 0.000 | Cul-De-Sac C3 |
